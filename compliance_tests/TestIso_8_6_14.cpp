...
class TestIso_8_6_14 : public test_lib::TestBase
{
    public:
        ...
        int Run()
        {
            ...
            for (size_t test_variant = 0; test_variant < test_variants.size(); test_variant++)
            {
                ...
                for (auto elem_test : elem_tests[test_variant])
                {
                     ...
                     *   4. Insert 7 Dominant bits from first bit of Error delimiter to driven
                     *      frame. Insert 7 recessive bits to monitored frame.
                    ...
                    for (int i = 0; i < 7; i++)
                    {
                        ...
                        driver_bit_frm->InsertBit(Bit(BitType::ActiveErrorFlag, BitValue::Dominant,
                            ...
                            bit_index);
                        monitor_bit_frm->InsertBit(Bit(BitType::ActiveErrorFlag, BitValue::Recessive,
                            frame_flags.get(), &nominal_bit_timing, &data_bit_timing),
                            bit_index);
                    }
