        ...
        int Run()
        {
            ...
            for (size_t test_variant = 0; test_variant < test_variants.size(); test_variant++)
            {
                ...
                for (auto elem_test : elem_tests[test_variant])
                {
                     ...
                     *      next bit on!
                     *   4. Superimpose active error flag on driven frame starting from 1/3/6th
                     *      bit of Passive Error flag. On monitored frame, insert passive error
                     *      frame again. This corresponds prolonging passive error flag until
                     *      sequence of equal consecutive bits is received!
                     *   5. Remove last bit of intermission in driven frame. This corresponds to
                     *      +2 bits separation in test description.
                     *   6. Turn monitored frame as if received, remove SOF since frame is
                     *      transmitted by LT after second bit of intermission.
                     *   7. Append the second frame to original frame. Second driven frame must
                     *      have ACK dominant since TX/RX feedback is disabled!
                     *****************************************************************************/
