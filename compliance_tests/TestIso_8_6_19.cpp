        ...
        int Run()
        {
            ...
            for (size_t test_variant = 0; test_variant < test_variants.size(); test_variant++)
            {
                ...
                for (auto elem_test : elem_tests[test_variant])
                {
                     ...
                     *   2. Flip 7-th identifier bit to dominant. This should be recessive stuff
                     *      bit and it should cause stuff error!
                     *   3. Insert Active Error frame to monitored frame. Insert Passive Error 
                     *      frame to driven frame since TX/RX feedback is enabled.
                     *   4. Append Retransmitted frame.
                     *****************************************************************************/
                    driver_bit_frm->TurnReceivedFrame();

                    driver_bit_frm->GetBitOf(6, BitType::BaseIdentifier)
