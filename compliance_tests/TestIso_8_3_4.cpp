        ...
        int Run()
        {
            ...
            for (int i = 0; i < iterCnt; i++)
            {
                ...
                for (int j = 0; j < 3; j++)
                {
                     ...
                     *     to driven frame.
                     *  4. Flip 2,4 or 7-th bit of Error delimiter to Dominant. Insert
                     *     next expected error frame from one bit further.
                     *  5. Turn second driven frame (the same) as received. Append
                    ...
                    Bit *bitToFlip = driver_bit_frame->GetBitOf(
                        bitIndexToFlip - 1, BitType::ErrorDelimiter);
