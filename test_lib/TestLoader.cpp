...
std::unique_ptr<test_lib::TestBase> ConstructTestObject(std::string name)
{
    ...
    if (name == "base") {
        ...
        test_ptr = std::make_unique<TestIso_7_5_1>();
        ...
        test_ptr = std::make_unique<TestIso_8_5_9>();
    } else if (name == "iso_8_5_10") {
        test_ptr = std::make_unique<TestIso_8_5_10>();
    } else if (name == "iso_8_6_1") {
        test_ptr = std::make_unique<TestIso_8_6_1>();
    } else if (name == "iso_8_6_2") {
        test_ptr = std::make_unique<TestIso_8_6_2>();
    } else if (name == "iso_8_6_3") {
        test_ptr = std::make_unique<TestIso_8_6_3>();
    } else if (name == "iso_8_6_4") {
        test_ptr = std::make_unique<TestIso_8_6_4>();
    } else if (name == "iso_8_6_5") {
        test_ptr = std::make_unique<TestIso_8_6_5>();
    } else if (name == "iso_8_6_6") {
        test_ptr = std::make_unique<TestIso_8_6_6>();
    } else if (name == "iso_8_6_8") {
        test_ptr = std::make_unique<TestIso_8_6_8>();
    } else if (name == "iso_8_6_9") {
        test_ptr = std::make_unique<TestIso_8_6_9>();
    } else if (name == "iso_8_6_10") {
        test_ptr = std::make_unique<TestIso_8_6_10>();
    } else if (name == "iso_8_6_11") {
        test_ptr = std::make_unique<TestIso_8_6_11>();
    } else if (name == "iso_8_6_12") {
        test_ptr = std::make_unique<TestIso_8_6_12>();
        ...
        test_ptr = std::make_unique<TestIso_8_6_16>();
    } else if (name == "iso_8_6_17") {
        test_ptr = std::make_unique<TestIso_8_6_17>();
    } else if (name == "iso_8_6_18") {
        test_ptr = std::make_unique<TestIso_8_6_18>();
    } else if (name == "iso_8_6_19") {
        test_ptr = std::make_unique<TestIso_8_6_19>();

    } else if (name == "iso_8_7_1") {
        test_ptr = std::make_unique<TestIso_8_7_1>();
